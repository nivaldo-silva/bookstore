...
CREATE INDEX idx_books_author_id ON books(author_fk);
CREATE INDEX idx_books_genre ON books(genre);
CREATE INDEX idx_books_isbn ON books(isbn);
CREATE INDEX idx_customers_email ON customers(email);
CREATE INDEX idx_orders_customer_id ON orders(customer_fk);
CREATE INDEX idx_order_items_order_id ON order_items(order_fk);
CREATE INDEX idx_order_items_book_id ON order_items(book_fk);
